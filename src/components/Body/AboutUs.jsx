        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
          <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
            <div className="w-full lg:w-6/12">
              ...
              <p className="font-normal text-base leading-6 text-[#d7d7d7] mt-6">
          ...
          <div className="relative mt-24">
            <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4 z-0 relative">
              <div className=" w-12 h-12 bg-[#4614B8] rounded-full flex justify-center items-center">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            {/* <hr className=" absolute top-2/4 w-full bg-gray-200" /> */}
          </div>
          <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
            <div>
              <p className="font-semibold lg:text-2xl  underline decoration-black hover:decoration-[#4714B7] text-xl lg:leading-6 leading-5 text-white mt-6">
                Founded
              </p>
              <p className="font-normal text-base leading-6 text-[#fff] mt-6">
                It is a long established fact that a reader will be distracted
                by the readable content of a page when looking at its layout.
              </p>
            </div>
            <div>
              <p className="font-semibold lg:text-2xl text-xl underline decoration-black hover:decoration-[#2B7F00] lg:leading-6 leading-5 text-white mt-6">
            ...
            <div className="sm:block hidden">
              <p className="font-semibold lg:text-2xl text-xl lg:leading-6 underline decoration-black hover:decoration-[#F30301] leading-5 text-white mt-6">
                400k User
              </p>
              <p className="font-normal text-base leading-6 text-[#fff] mt-6">
                It is a long established fact that a reader will be distracted
          ...
          <div className="sm:hidden grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
            <div>
              <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5  underline decoration-black hover:decoration-[#F30301]  text-white mt-6">
                400k User
              </p>
              <p className="font-normal text-base leading-6 text-[#fff] mt-6">
                It is a long established fact that a reader will be distracted
          ...
          <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
            <div className="w-full lg:w-6/12">
              ...
              <p className="font-normal text-base leading-6 text-[#d7d7d7] mt-6 w-full lg:w-10/12 xl:w-9/12">
                It is a long established fact that a reader will be distracted
                by the readable content of a page when looking at its layout.
                The point of using Lorem Ipsum.In the first place we have
                granted to God, and by this our present charter confirmed for us
              ...
              <p className="font-normal text-base leading-6 text-[#d7d7d7] w-full lg:w-10/12 xl:w-9/12 mt-10">
                It is a long established fact that a reader will be distracted
                by the readable content of a page when looking at its layout.
                The point of using Lorem Ipsum.In the first place we have
                granted to God, and by this our present charter confirmed for us
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                ...
                <div className="flex p-4 shadow-md">
                  ...
                  <div className="">
                    ...
                    <p className="mt-2 font-normal text-base leading-6 text-[#fff]">
