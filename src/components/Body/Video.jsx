  ...
  return (
    <div>
      ...
      <div className="relative">
        <video autoPlay loop muted className="w-full h-[800px] object-cover">
        ...
        <div className="absolute mt-12 w-[80%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          ...
          <div className="mt-6 flex items-center ">
            <button className=" bg-[#4614B9]   text-white text-[20px] font-semibold px-12 py-[15px] rounded-lg hover:bg-[#4614B9]  border-none mt-4">
              Book A Demo
            </button>
            <button className=" bg-[#191919] flex items-center ml-6  text-white text-[20px] font-semibold px-6 py-[15px] rounded-lg hover:bg-[#191919]  border-none mt-4">
              <div>
          ...
          <div className="absolute mt-56 w-[35px] h-[50px] border-2 border-white rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
