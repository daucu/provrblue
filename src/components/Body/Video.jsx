  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        {/*  */}
        <div className="absolute mt-16 w-[80%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <h1 className="text-6xl font-extralight  text-white">
            Interactive 3D Solutions for Real Estate
          </h1>
          <div className="mt-6 flex items-center ">
            <button className=" bg-[#4614B9]   text-white text-[17px] font-normal px-12 py-[10px] rounded-lg hover:bg-[#4614B9]  border-none mt-4">
              Book A Demo
            </button>
            <button className=" bg-[#191919] flex items-center ml-6  text-white text-[17px] font-normal px-6 py-[10px] rounded-lg hover:bg-[#191919]  border-none mt-4">
              <div>
