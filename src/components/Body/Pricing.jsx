    ...
    <div>
      ...
      <div className=" mt-16  bg-[#000000]  flex flex-wrap items-center  justify-center  ">
        <div className="flex flex-col sm:flex-col lg:flex-row xl:flex-row md:flex-row justify-center items center  container   ">
          ...
          <div className="py-12 sm:py-12 cursor-pointer hover:border-2 hover:border-[#4614B9] border-2  md:py-6 lg:py-6 xl:py-20 px-16 w-full md:max-w-min sm:w-full bg-purple-500 transform scale-1 sm:scale-1 md:scale-105 lg:scale-105 xl:scale-105 z-40  shadow-none sm:shadow-none md:shadow-xl rounded-md lg:shadow-xl xl:shadow-xl">
          ...
          <div className="py-12 sm:py-12 cursor-pointer hover:border-2 hover:border-[#4614B9] ml-6 border-2  md:py-6 lg:py-6 xl:py-20 px-16 w-full md:max-w-min sm:w-full bg-[#fbf3e8] rounded-md z-30">
