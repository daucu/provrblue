    ...
    <div>
      ...
      >
        <div className="flex flex-col sm:flex-col lg:flex-row xl:flex-row md:flex-row justify-center items center  container   ">
          ...
          <div className="py-12 sm:py-12 cursor-pointer hover:border-2 hover:border-[#4614B9] ml-6 border-2  md:py-6 lg:py-6 xl:py-20 px-16 w-full md:max-w-min sm:w-full bg-[#fbf3e8] rounded-md ">
